...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        // Добавляем продукт Chocolate
        Product chocolate = new Chocolate("Milka", "Шоколадка", 70, 300);
        ...
        arrayList.add(chocolate); // Добавляем шоколад в список продуктов

        VendingMachine vendingMachine = new VendingMachine(arrayList);

        BottleOfMilk purchasedMilk = vendingMachine.getBottleOfMilk("Бутылка с молоком (3)", 2);
        if (purchasedMilk != null) {
            System.out.println("Вы купили:");
            System.out.println(purchasedMilk.displayInfo());
        } else {
            System.out.println("Такой бутылки с молоком нет в автомате.");
        }

        // Продажа шоколадки
        Chocolate purchasedChocolate = vendingMachine.getChocolate("Шоколадка", 70);
        if (purchasedChocolate != null) {
            System.out.println("Вы купили:");
            System.out.println(purchasedChocolate.displayInfo());
        } else {
